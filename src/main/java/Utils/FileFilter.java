...
import pdf2htmlConvertor.Pdf2HtmlEx;
import pdf2htmlConvertor.Util;
...
public abstract class FileFilter {
    ...
    public abstract String getFilteringRegex();

    public abstract String getInputFolder();

    public abstract String getOutputFolder();

    public abstract void processFile(String inputFile, String outputFolder, String fileName);

    public void execute() throws IOException {
        parseFileInFolder(getInputFolder(), getOutputFolder());
    }
    ...
    private void recurseDirectory(File currentNode, File inputNode, File outputNode) {
        ...
        String filteringRegex = getFilteringRegex();
        Pattern xmlRegex = Pattern.compile(filteringRegex);
        for (String subNodeName : fileList) {
            ...
            if (subNode.isDirectory()) {
                ...
                processFile(inputFile, outputFolder, subNodeName);
            }
        }
    }
