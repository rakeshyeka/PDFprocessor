...
public class CssParserConstants {
	...
	public static final String X_POSITION_PATTERN = "(?!\\.x[0-9a-fA-F]+ \\{ left: )[0-9]+\\.[0-9]+(?=pt \\})";
	public static final String Y_POSITION_PLAIN = ".y";
	public static final String Y_POSITION = "\\.(y[0-9a-fA-F]+)";
	public static final String Y_POSITION_PATTERN = "(?!\\.y[0-9a-fA-F]+ \\{ bottom: )[0-9]+\\.[0-9]+(?=pt \\})";
	public static final String FONT_SIZE_PLAIN = ".fs";
	public static final String FONT_SIZE = "\\.(fs[0-9a-fA-F]+)";
	public static final String FONT_SIZE_PATTERN = "(?!\\.fs[0-9a-fA-F]+ \\{ font-size: )[0-9]+\\.[0-9]+(?=pt \\})";
}
